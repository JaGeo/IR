...
myIR.write_gaussiansmearedspectrum("SmearedOscillatorStrengths.txt", sigma=20)
myIR.plot_spectrum("OscillatorStrengths.eps")
myIR.plot_gaussiansmearedspectrum("SmearedOscillatorStrengths.eps", sigma=20)
